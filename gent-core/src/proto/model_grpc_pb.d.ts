...
interface IBrokerService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  get_processes: grpc.MethodDefinition<model_pb.ProcessIds, model_pb.Processes>;
}
...
export interface IBrokerServer extends grpc.UntypedServiceImplementation {
  ...
  get_processes: grpc.handleUnaryCall<model_pb.ProcessIds, model_pb.Processes>;
}
...
export class BrokerClient extends grpc.Client {
  ...
  get_processes(argument: model_pb.ProcessIds, callback: grpc.requestCallback<model_pb.Processes>): grpc.ClientUnaryCall;
  get_processes(argument: model_pb.ProcessIds, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<model_pb.Processes>): grpc.ClientUnaryCall;
  get_processes(argument: model_pb.ProcessIds, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<model_pb.Processes>): grpc.ClientUnaryCall;
}
